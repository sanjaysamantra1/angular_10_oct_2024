...
import { FolderchildComponent } from '../folderchild/folderchild.component';

@Component({
  selector: 'app-folderexplorer',
  standalone: true,
  imports: [FolderchildComponent],
  templateUrl: './folderexplorer.component.html',
  styleUrl: './folderexplorer.component.css',
})
